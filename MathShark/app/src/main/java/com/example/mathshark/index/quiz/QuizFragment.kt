...
class QuizFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        currentLesson = sharedDataViewModel.lessons.value?.find { it.id == lessonId } ?: LessonDataInfo(0, "", "", "", false,0, false, false, false, false, "", "")
        ...
        binding.descriptionQuiz.text = "A continuación, tendrás que resonder dos preguntas relacionadas al tema ${currentLesson.titulo}. Una vez respondidas ambas preguntas correctamente, podrás avanzar a la siguiente lección."
    ...
    private fun setupRecyclerView(quizData: List<SharedDataViewModel.QuizDataInfo>) {
        ...
        binding.quizButton.isEnabled = false
    }
    ...
    private fun setupQuizButton() {
        binding.quizButton.setOnClickListener {
            ...
            if (quizAdapter.validateAnswers()) {
                ...
                sharedDataViewModel.markCompletedLessons(currentLesson.id)
