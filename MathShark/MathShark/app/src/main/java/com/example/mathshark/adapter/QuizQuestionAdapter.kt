...
class QuizAdapter(
    ...
    override fun onBindViewHolder(holder: QuizViewHolder, position: Int) {
        ...
        // Añadir respuestas al RadioGroup
        ...
        radioGroup.setOnCheckedChangeListener { group, checkedId ->
            ...
            onSelectionChanged(selectedAnswers.size == dataList.size)  // Notificar cuando todas las preguntas tengan respuesta
        }
    }
    ...
    fun resetSelections() {
        ...
        notifyDataSetChanged()  // Esto reiniciará la selección en todas las preguntas
    }
}
